...
void protobuf_AssignDesc_model_2fimage_2eproto() {
  protobuf_AddDesc_model_2fimage_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_model_2fimage_2eproto);
}
...
void protobuf_ShutdownFile_model_2fimage_2eproto() {
...
void protobuf_AddDesc_model_2fimage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "mokade.image.proto.DimenzijaSlike", 273);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_model_2fimage_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_model_2fimage_2eproto {
  StaticDescriptorInitializer_model_2fimage_2eproto() {
    protobuf_AddDesc_model_2fimage_2eproto();
  }
} static_descriptor_initializer_model_2fimage_2eproto_;
...
const Zahtjev& Zahtjev::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_model_2fimage_2eproto();
...
void Odgovor::InitAsDefaultInstance() {
  velicinaslike_ = const_cast< ::com::emajliramokade::image::proto::DimenzijaSlike*>(&::com::emajliramokade::image::proto::DimenzijaSlike::default_instance());
}
...
void Odgovor::MergeFrom(const Odgovor& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_velicinaslike()) {
      mutable_velicinaslike()->::com::emajliramokade::image::proto::DimenzijaSlike::MergeFrom(from.velicinaslike());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
