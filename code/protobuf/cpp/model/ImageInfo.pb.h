...
class Odgovor : public ::google::protobuf::Message {
 public:
  ...
  inline const ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike& velicinaslike() const;
  inline ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* mutable_velicinaslike();
  inline ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* release_velicinaslike();
  inline void set_allocated_velicinaslike(::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* velicinaslike);
 ...
 private:
  ...
  ::std::string* poruka_;
  ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* velicinaslike_;
  bool status_;
...
inline const ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike& Odgovor::velicinaslike() const {
  return velicinaslike_ != NULL ? *velicinaslike_ : *default_instance_->velicinaslike_;
}
inline ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* Odgovor::mutable_velicinaslike() {
  set_has_velicinaslike();
  if (velicinaslike_ == NULL) velicinaslike_ = new ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike;
  return velicinaslike_;
}
inline ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* Odgovor::release_velicinaslike() {
  clear_has_velicinaslike();
  ::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* temp = velicinaslike_;
  velicinaslike_ = NULL;
  return temp;
}
inline void Odgovor::set_allocated_velicinaslike(::com::emajliramokade::proto::ImageInfo::DimenzijaSlike* velicinaslike) {
