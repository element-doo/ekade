...
require_once __DIR__.'/KadaOdbijenaJsonConverter.php';
 ...
 * @version 0.9.9 beta
 */
class KadaOdbijena extends \NGS\Patterns\DomainEvent
{
    protected $URI;
    protected $kadaID;

    /**
     * Constructs object using a key-property array or instance of class "PopisKada\KadaOdbijena"
     *
     * @param array|void $data key-property array or instance of class "PopisKada\KadaOdbijena" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "PopisKada\KadaOdbijena" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "PopisKada\KadaOdbijena" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    {
        if ($name === 'URI')
            throw new \LogicException('Property "URI" in "PopisKada\KadaOdbijena" cannot be set, because event URI is populated by server!');
        if ($name === 'kadaID')
            return $this->setKadaID($value); // a uuid
        throw new \InvalidArgumentException('Property "'.$name.'" in class "PopisKada\KadaOdbijena" does not exist and could not be set!');
    }
    ...
    {
        return \PopisKada\KadaOdbijenaJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \PopisKada\KadaOdbijenaJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'PopisKada\KadaOdbijena'.$this->toJson();
    }

    public function __clone()
    {
        return \PopisKada\KadaOdbijenaArrayConverter::fromArray(\PopisKada\KadaOdbijenaArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \PopisKada\KadaOdbijenaArrayConverter::toArray($this);
    }
}
