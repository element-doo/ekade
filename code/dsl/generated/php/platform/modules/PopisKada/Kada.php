 ...
 * @property \NGS\UUID $ID used by reference $slikeKade (read-only)
 ...
 * @property \Resursi\SlikeKade $slikeKade an object of class "Resursi\SlikeKade"
 *
 * @package PopisKada
 * @version 0.9.9 beta
 */
class Kada extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    ...
    private function fromArray(array $data)
    {
        ...
        if(array_key_exists('slikeKadeURI', $data))
            $this->slikeKadeURI = \NGS\Converter\PrimitiveConverter::toString($data['slikeKadeURI']);
...
// ============================================================================
    ...
    private static $_read_only_properties = array('URI', 'ID', 'dodana', 'slikeKadeURI');
    ...
    /**
     * @param \Resursi\SlikeKade $value an object of class "Resursi\SlikeKade"
     *
    ...
    public function setSlikeKade($value)
    {
        ...
        $value = \Resursi\SlikeKadeArrayConverter::fromArray($value);
        if ($value->URI === null)
    ...
    public function __set($name, $value)
    {
        ...
        if ($name === 'slikeKade')
            return $this->setSlikeKade($value); // an object of class "Resursi\SlikeKade"
    ...
    public function __unset($name)
    {
        ...
        if ($name === 'slikeKade')
            throw new \LogicException('The property "slikeKade" cannot be unset because it is non-nullable!'); // an object of class "Resursi\SlikeKade" (cannot be unset)
    }
    ...
    public function persist()
    {
        ...
        if ($this->slikeKadeURI === null && $this->ID !== null) {
            throw new \LogicException('Cannot persist instance of "PopisKada\Kada" because reference "slikeKade" was not assigned');
        }
