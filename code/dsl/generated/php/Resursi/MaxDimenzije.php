...
// ============================================================================
    ...
    /**
     * Static instance: original
     *
     * @return object of type \Resursi\MaxDimenzije
     */
    public static function original()
    {
        if (self::$_original === null)
            self::$_original = \Resursi\MaxDimenzijeJsonConverter::fromJson('{"ID":"","width":4000,"height":4000,"URI":"Original"}');
        if (self::$_original === null)
            self::$_original = self::find('Original');
     ...
     * Static instances
     *
     * @return array of all static instances of type \Resursi\MaxDimenzije
     */
    ...
    {
        if (self::$_web === null)
            self::$_web = \Resursi\MaxDimenzijeJsonConverter::fromJson('{"ID":"","width":1280,"height":960,"URI":"Web"}');
        if (self::$_web === null)
            self::$_web = self::find('Web');
        return self::$_web;
    }
    ...
    {
        if (self::$_email === null)
            self::$_email = \Resursi\MaxDimenzijeJsonConverter::fromJson('{"ID":"","width":640,"height":640,"URI":"Email"}');
        if (self::$_email === null)
            self::$_email = self::find('Email');
        return self::$_email;
    }
    ...
    {
        if (self::$_thumbnail === null)
            self::$_thumbnail = \Resursi\MaxDimenzijeJsonConverter::fromJson('{"ID":"","width":200,"height":200,"URI":"Thumbnail"}');
        if (self::$_thumbnail === null)
            self::$_thumbnail = self::find('Thumbnail');
